...
keyboard = [
[InlineKeyboardButton(“➕ Qarz qo’shish”, callback_data=f”add_debt*{client_id}”)],
...
client = conn.execute(“SELECT * FROM clients WHERE id=?”, (client_id,)).fetchone()
conn.close()
keyboard = [[InlineKeyboardButton(“◀️ Orqaga”, callback_data=f”client*{client_id}”)]]
await query.edit_message_text(
...
conn.close()
keyboard = [
[InlineKeyboardButton(“✅ Ha, o’chirish”, callback_data=f”do_delete*{client_id}”)],
